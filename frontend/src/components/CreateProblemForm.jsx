...
examples: {
  JAVASCRIPT: {
    input: 's = "Race a car"',
    output: "false",
    explanation: '"raceacar" is not the same when reversed, so it is not a palindrome.',
  },
  PYTHON: {
    input: 's = "No lemon, no melon"',
    output: "true",
    explanation: '"nolemonnomelon" reads the same forward and backward.',
  },
  JAVA: {
    input: 's = "Was it a rat I saw?"',
    output: "true",
    explanation: '"wasitaratisaw" is a palindrome after removing non-alphanumeric characters.',
  },
},
...
const CreateProblemForm = () => {
 ...
 const loadSampleData = () => {
  ...
  replacetestcases(sampleData.testscases.map((tc) => tc));
        ...
        <div className="card-body p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="card bg-base-200 p-4 md:p-6 shadow-md">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        <div className="form-control">
                          ...
                          <textarea
                            ...
                            {...register(`testscases.${index}.input`)}
                            placeholder="Enter test case input"
                          />
                          {errors.testscases?.[index]?.input && (
                            <label className="label">
                              <span className="label-text-alt text-error">
                                {errors.testscases[index].input.message}
                              </span>
                            </label>
                          )}
                        </div>
                        <div className="form-control">
                          ...
                          <textarea
                            className="textarea textarea-bordered min-h-24 w-full p-3 resize-y"
                            {...register(`testscases.${index}.output`)}
                            placeholder="Enter expected output"
                          />
                          {errors.testscases?.[index]?.output && (
                            <label className="label">
                              <span className="label-text-alt text-error">
                                {errors.testscases[index].output.message}
                              </span>
                            </label>
                          )}
                        </div>
              ...
              {errors.testscases && !Array.isArray(errors.testscases) && (
                <div className="mt-2">
                  <span className="text-error text-sm">
                    {errors.testscases.message}
                  </span>
                </div>
              )}
            </div>
