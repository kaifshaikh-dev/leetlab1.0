/*
  ...
  - You are about to drop the `Problesm` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "Problesm" DROP CONSTRAINT "Problesm_userId_fkey";
